...
package fr.xebia.xke.test.jdbc.core;
...
/**
 * Processes sql scripts. A list of scripts or script locations can be set.
 * Spring <code>ResourceLoader</code> is used so valid scripts locations are
 * classpath, file, http, ftp. etc.
 * 
...
public class SqlScriptProcessor implements InitializingBean, ResourceLoaderAware {
    ...
    /**
     * Gets charset used to process a sql script file (ex: 'UTF-8'). If not set,
     * default character set of the JVM is used.
     */
    ...
    /**
     * Sets charset used to process a sql script file (ex: 'UTF-8'). If not set,
     * default character set of the JVM is used.
     */
